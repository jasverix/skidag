...
function cycle(wrapper, _ref) {
  ...
  function doCycle() {
    // the visible element
    var selected = elements.filter(':visible');

    // the element to display - the next element to the visible one
    var toDisplay = selected.next();
  ...
  /***/ (function (module, exports, __webpack_require__) {
    ...
    !function (e, t) {
      ...
      var n = [], r = e.document, i = Object.getPrototypeOf, o = n.slice, a = n.concat, s = n.push, u = n.indexOf,
        l = {}, c = l.toString, f = l.hasOwnProperty, p = f.toString, d = p.call(Object), h = {}, g = function e (t) {
